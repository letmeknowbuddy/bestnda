...
<title>Blogs | Shield Defence College</title>
...
<div id="content" class="container-fluid">
 ...
 <div class="panel panel-default">
  ...
  <div class="panel-heading">
   ...
   <h1 class="panel-title"><i class="fa-solid fa-blog"></i> All Blog List</h1>

   <div class="pull-right">

    <a href="{{ route('admin.add_blog')}}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="Add Blog"><i class="fa fa-plus"></i></a>
    ...
    <table class="table table-striped table-bordered table-hover" id="myTable">
     ...
     <thead>
      ...
      <tr class="success">
       ...
       <th class="text-center" width="4%">Views</th>
     ...
     <tbody>
...

      {
       ...
       <td class="text-center">{{$blogs->blog_title}}</td>

       <td class="text-center">{{$blogs->u_name}}</td>

       <td class="text-center">{{$blogs->category}}</td>

       <td class="text-center">4</td>

       <td class="text-center">{{$blogs->create_at}} PM</td>
       ...
       <td class="text-center">
        ...
        <a href="{{ route ('admin.edit_blog',$blogs->id)}}" class="btn btn-primary btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="Edit"><i class="fas fa-pen"></i></a>



        <a onclick="return confirm('Are you sure you want to delete page. ?');" href="#!" class="btn btn-info btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="View"><i class="fas fa-eye"></i></a>



        <a onclick="return confirm('Are you sure you want to delete page. ?');" 

        href="{{ route('admin.deliteblog',$blogs->id)}}" class="btn btn-danger btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="Delete"><i class="fas fa-trash-alt"></i></a>
