...
<title>Add Category | Shield Defence College</title>
...
<div id="content" class="container-fluid">
 ...
 <form method="POST" action="{{ route('admin.categury')}}" class="form-horizontal" enctype="multipart/form-data">
 @csrf
 <div class="panel panel-default">
  <div class="panel-heading">
   <h1 class="panel-title"><i class="far fa-edit"></i> Add Category</h1>
    ...
    <div class="row">
     <div class="col-lg-4 col-md-6 col-sm-12">
      <div class="form-group">
       <input type="text" name="cate_name" class="form-control"  id="Text" onkeyup="CopyData(this)"  required>
       <label class="required">Category Name</label>
      </div>
     </div>
     <div class="col-lg-4 col-md-6 col-sm-12">
      <div class="form-group">
       <input type="text" name="cate_slug" class="form-control" id="slug" style="text-transform:lowercase"  required>
