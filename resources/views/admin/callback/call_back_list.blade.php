...
<title>Call Back Lists | Shield Defence College</title>
...
<div id="content" class="container-fluid">
 <ol class="breadcrumb">
  ...
  <li>Call Back Lists</li>
 </ol>
 <div class="panel panel-default">
  <div class="panel-heading">
   <h1 class="panel-title"><i class="fas fa-phone-volume"></i> Call Back Lists</h1>
  </div>
      ...
      foreach($callback as $call)
      {
        ...
        <tr>
         <td class="text-center">{{$count++}}</td>
          <td class="text-center">{{ $call->name}}</td>
         <td class="text-center">{{$call->phone}}</td>
         <td class="text-center">{{$call->course}}</td>
         <td class="text-center">{{$call->time_stamp}}</td>
 ...
 <!-- <a href="edit_contact.php" class="btn btn-primary btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="Edit"><i class="fas fa-pen"></i></a> -->
        ...
        href="{{ route('admin.delitecalback',$call->id)}}" class="btn btn-danger btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="Delete"><i class="fas fa-trash-alt"></i></a>
</td>
</tr>
