...
<title>Online Fee Paymant | Shield Defence College</title>
...
<div id="content" class="container-fluid">
 <ol class="breadcrumb">
  ...
  <li>Online Fee Paymants</li>
 </ol>
 <div class="panel panel-default">
  <div class="panel-heading">
   <h1 class="panel-title"><i class="fas fa-phone-volume"></i> Online Fee Paymants</h1>
  </div>
...
<td class="text-center">{{$pays->name}}</td>
<td class="text-center">{{$pays->phone}}</td>
<td class="text-center">{{$pays->course}}</td>
<td class="text-center">{{$pays->create_at}}</td>
<td class="text-center">
<a href="{{ route('admin.view_payment',$pays->id)}}" class="btn btn-info btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="View"><i class="fas fa-eye"></i></a>
<a onclick="return confirm('Are you sure you want to delete page. ?');" 
 href="{{ route('admin.delfess',$pays->id)}}" class="btn btn-danger btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="Delete"><i class="fas fa-trash-alt"></i></a>
</td>
</tr>
