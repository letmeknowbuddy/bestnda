...
<title>Add Page | Shield Defence College</title>
...
<div id="content" class="container-fluid">
 <ol class="breadcrumb">
  ...
  <li><a href="pages.php">Page List</a></li>
  <li>Add Page</li>
 </ol>
 <form method="POST" action="{{ route ('admin.savepage')}}"  class="form-horizontal" enctype="multipart/form-data">
  @csrf
  <div class="panel panel-default">
  <div class="panel-heading">
   <h1 class="panel-title"><i class="far fa-edit"></i> Add Page</h1>
  ...
  <div class="panel-body">
    <div class="row">
     <div class="col-lg-6 col-md-6 col-sm-12">
      <div class="form-group">
       <input type="text" name="page_name" class="form-control" id="Text" onkeyup="CopyData(this)" required>
       <label class="required">Page Name</label>
      </div>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-12">
      <div class="form-group">
       <input type="text" name="slug" class="form-control" id="slug" style="text-transform:lowercase" required>
     ...
     <div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <p class="pull-right mb-0"><i><b>Note</b> : Add Minimum <b id="metatitlecount">1 Keyword</b> & Maximum <b>15 Keyword</b>.</i></p>
     </div>
     <div class="col-lg-12 col-md-12 col-sm-12">
      <div class="form-group">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
      <div class="form-group">
       <input type="file" name="og_img" class="form-control" required>
